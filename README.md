...
1. **Clone the repository**:
    ```bash
    git clone https://github.com/abhishekgurjarin/Tic-Tac-Toe.git
    ```
...
You can check out the live demo of the Tic-Tac-Toe Game [here](https://abhishekgurjarin.github.io/Tic-Tac-Toe/).
## Screenshots
